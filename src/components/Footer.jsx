        ...
        <Grid col={4} mdCol={2} smCol={1} gap={10}>
          <div>
            ...
            <div className="footer__content">
              <p>
                Liên hệ đặt hàng <strong>0987932899</strong>
              </p>
              <p>
                Thắc mắc đơn hàng <strong>0987932899</strong>
              </p>
              <p>
                Góp ý, khiếu nại <strong>0987932899</strong>
              </p>
            </div>
          </div>
          <div>
          ...
          <div className="footer__about">
            ...
            <p>
              ...
              người tiêu dùng Việt. Hãy cũng Yolo hướng đến một cuộc sống năng động, tích
              cực hơn.
            </p>
          </div>
        </Grid>
